<x-filament-panels::layout.base :livewire="$livewire">
    <div class="fi-layout flex min-h-screen w-full flex-col">
        ...
        <div class="fi-topbar sticky top-0 z-20 flex w-full justify-between gap-4 h-16 items-center px-4 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-800">
             <div class="flex items-center gap-x-4 min-w-0">
                @if ($homeUrl = filament()->getHomeUrl())
                    <a href="{{ $homeUrl }}" class="flex items-center gap-x-2 min-w-0">
                        {{-- Logo ou Nome --}}
                        <span class="text-lg font-bold tracking-tight text-gray-950 dark:text-white sm:text-xl truncate">
