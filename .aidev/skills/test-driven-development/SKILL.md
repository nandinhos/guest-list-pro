...
## Laravel/PHP Examples (guest-list-pro)

### PHPUnit Test com Mockery
```php
...
```php
// tests/Feature/ApprovalRequestResourceTest.php
use function Pest\Laravel\postJson;

it('creates approval request and sends notification', function () {
...
class GuestFactory extends Factory {
    public function definition(): array {
        return [
            ...
            'document_normalized' => fn($attrs) => DocumentValidationService::normalize($attrs['document']),
        ];
    }
