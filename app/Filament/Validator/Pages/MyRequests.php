...
class MyRequests extends Page implements HasTable
{
    ...
    protected string $view = 'filament.validator.pages.my-requests';
        ...
        return $table
            ...
            ->columns([
                ...
                ViewColumn::make('mobile_card')
                    ->view('filament.validator.pages.requests.mobile_card')
                    ->label('SOLICITAÇÕES')
                    ->hiddenFrom('md'),
            ...
            ->emptyStateDescription('Suas solicitações de check-in emergencial aparecerão aqui.')
